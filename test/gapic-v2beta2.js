...
describe('DlpServiceClient', () => {
  ...
  describe('inspectDataSource', () => {
    it('invokes inspectDataSource without error', done => {
      var client = new dlpModule.v2beta2.DlpServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      // Mock Grpc layer
      client._innerApiCalls.inspectDataSource = mockSimpleGrpcMethod(
        request,
        expectedResponse
      );

      client.inspectDataSource(request, (err, response) => {
        assert.ifError(err);
        assert.deepStrictEqual(response, expectedResponse);
        done();
      });
    ...
    it('invokes inspectDataSource with error', done => {
      var client = new dlpModule.v2beta2.DlpServiceClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
